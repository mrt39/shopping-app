...
export default function DashboardListItems({changeApiLink}) { 
  ...
  function handleClick(categoryName){
    ...
    if (categoryName ==="highestRated") {
      apiLink = `https://api.rawg.io/api/games?key=e6ddcb78aeda4b678f21e8f6a97890cf&page_size=39&exclude_stores=4,9&ordering=-metacritic&page=1`
    }
    if (categoryName ==="mostPopular") {
      apiLink = `https://api.rawg.io/api/games?key=e6ddcb78aeda4b678f21e8f6a97890cf&page_size=39&exclude_stores=4,9&ordering=-rating&page=1`
    }
    if (categoryName ==="newReleases") {
      apiLink = `https://api.rawg.io/api/games?key=e6ddcb78aeda4b678f21e8f6a97890cf&page_size=39&stores=6,2,7,1,3&dates=1960-01-01,${getThisYear()}-12-31&ordering=-released&page=1`
    }
    if (categoryName ==="bestOf2023") {
      apiLink = `https://api.rawg.io/api/games?key=e6ddcb78aeda4b678f21e8f6a97890cf&page_size=39&exclude_stores=4,9&ordering=-metacritic&dates=${getThisYear()}-01-01,${getThisYear()}-12-31&page=1`
    }
    if (categoryName ==="action") {
      apiLink = `https://api.rawg.io/api/games?key=e6ddcb78aeda4b678f21e8f6a97890cf&page_size=39&exclude_stores=4,9&ordering=-metacritic&genres=action&page=1`
    }
    if (categoryName ==="shooter") {
      apiLink = `https://api.rawg.io/api/games?key=e6ddcb78aeda4b678f21e8f6a97890cf&page_size=39&exclude_stores=4,9&ordering=-metacritic&genres=shooter&page=1`
    }
    if (categoryName ==="strategy") {
      apiLink = `https://api.rawg.io/api/games?key=e6ddcb78aeda4b678f21e8f6a97890cf&page_size=39&exclude_stores=4,9&ordering=-metacritic&genres=strategy&page=1`
    }
    if (categoryName ==="rpg") {
      apiLink = `https://api.rawg.io/api/games?key=e6ddcb78aeda4b678f21e8f6a97890cf&page_size=39&exclude_stores=4,9&ordering=-metacritic&genres=role-playing-games-rpg&page=1`
    }
    if (categoryName ==="adventure") {
      apiLink = `https://api.rawg.io/api/games?key=e6ddcb78aeda4b678f21e8f6a97890cf&page_size=39&exclude_stores=4,9&ordering=-metacritic&genres=adventure&page=1`
    }
