      ...
      >
        <div id="gamePageContainer">
          ...
          <div id='gameDescriptionContainer'>
            <h2 id='gamePageGameTitle'>{gameDetails.name}</h2>
            <p id='gameDescription'>{gameDetails.description_raw}</p>

            <div id='gamePageAddToCartDiv'> 
              <h3 id>${price.price}</h3>
              {checkIfInCart()? 
                <h3 id='gamePageInCart'>✓ In Cart</h3>
              : 
                <h3>
                  <a href="#" 
                  onClick={() => handleAddtoCart({gameName: gameDetails.name}, price.price, {imgUrl: gameScreenshots.gameScreenshots[0].image})}>
                  Add To Cart
                  </a>
                </h3>
              }
