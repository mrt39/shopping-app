...
function HomePage({changeApiLink}) {
  ...
  const handleSubmit = (e) => {
    ...
    changeApiLink(`https://api.rawg.io/api/games?key=e6ddcb78aeda4b678f21e8f6a97890cf&page_size=39&stores=1,2,3,5,6,7,11&exclude_stores=4,8,9&search=${inputVal}&page=1`)
    navigate("/")
